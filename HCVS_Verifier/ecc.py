...
class ECC:
    ...
    def load_public_key_raw(self, public_key_raw):
        public_key_x = int.from_bytes(public_key_raw[:32], byteorder="big")
        public_key_y = int.from_bytes(public_key_raw[32:], byteorder="big")
